    ...
    def add_scouting_data(self, data: dict, scouter_id: str) -> tuple[bool, str]:
        ...
        try:
            ...
            team_data = {
                ...
                "defense_response_notes": data.get("defense_response_notes", ""),

                # Herd and Ferrying
                "herd_balls": data.get("herd_balls") == "true" or data.get("herd_balls") is True,
                "herd_rating": int(data.get("herd_rating", 5)) if (data.get("herd_balls") == "true" or data.get("herd_balls") is True) else 0,
                "ferrying_did": data.get("ferrying_did") == "true" or data.get("ferrying_did") is True,
                "ferrying_rating": int(data.get("ferrying_rating", 5)) if (data.get("ferrying_did") == "true" or data.get("ferrying_did") is True) else 0,
